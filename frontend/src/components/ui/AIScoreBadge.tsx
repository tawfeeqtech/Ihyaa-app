...
export type ScoreTier = "weak" | "medium" | "good" | "excellent";
...
const tierClasses: Record<ScoreTier, { badge: string; dot: string; ring: string }> = {
  weak: {
...
interface AIScoreBadgeProps {
  score: number;
  /** Show the translated tier label next to the score (default true) */
  showLabel?: boolean;
  /** Circular ring style (used on project detail) */
  ring?: boolean;
  className?: string;
}
