...
export type ProjectStatus = "completed" | "needs_development" | "needs_funding";

export interface Project {
  id: string;
  title: LocalizedText;
  description: LocalizedText;
  sector: string; // key into sectorOptions
  tags: string[];
  aiScore: number;
  dimensions: {
    technical: number;
...
export const sectorLabels: Record<string, LocalizedText> = {
