...
import { sectorOptions, sectorLabels, type ProjectStatus } from "@/lib/mock-data";
            ...
            <div className="space-y-5">
              ...
              <fieldset>
                ...
                <div className="grid gap-3 sm:grid-cols-3">
                  {(["completed", "needs_development", "needs_funding"] as const).map((status) => (
                    <button
                      key={status}
                      type="button"
                      role="radio"
            ...
            <div className="space-y-6">
              ...
              <fieldset>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {(["public", "investors_only"] as const).map((visibility) => (
                    <button
                      key={visibility}
                      type="button"
                      role="radio"
